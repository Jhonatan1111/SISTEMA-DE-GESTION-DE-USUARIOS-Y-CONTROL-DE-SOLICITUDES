<x-app-layout>
    <div class="max-w-5xl mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-extrabold text-blue-700">Editar Biopsia - Persona</h1>
                <p class="text-sm text-gray-500 mt-1">Número: <span class="font-semibold text-green-600">{{ $biopsia->nbiopsia }}</span></p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <select id="lista_id" name="lista_id"
                                ...
                                <option value="{{ $lista->id }}" {{ old('lista_id', $biopsia->lista_id) == $lista->id ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <textarea id="diagnostico" name="diagnostico" rows="3"
                                class="w-full px-4 py-2 border-2 border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition-all">{{ old('diagnostico', $biopsia->diagnostico) }}</textarea>
                        </div>
                        <div>
                            <label for="descripcion" class="block text-sm font-semibold text-gray-700 mb-1">Descripción General</label>
                            <textarea id="descripcion" name="descripcion" rows="3"
                                class="w-full px-4 py-2 border-2 border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition-all">{{ old('descripcion', $biopsia->descripcion) }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="macroscopico" name="macroscopico" rows="3"
                                class="w-full px-4 py-2 border-2 border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition-all">{{ old('macroscopico', $biopsia->macroscopico) }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="microscopico" name="microscopico" rows="3"
                                class="w-full px-4 py-2 border-2 border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-500 transition-all">{{ old('microscopico', $biopsia->microscopico) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
