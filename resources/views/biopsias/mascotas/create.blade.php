<x-app-layout>
    <div class="container mx-auto px-4 py-6">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Nueva Biopsia de Mascota</h1>
            <p class="text-gray-600 mt-1">Registrar una nueva biopsia para mascota</p>
        </div>
            ...
            <form action="{{ route('biopsias.mascotas.store') }}" method="POST" class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- Mascota -->
                        <div>
                            <label for="mascota_id" class="block text-sm font-semibold text-gray-700 mb-1">
                            ...
                            <select id="mascota_id"
                                ...
                                <option value="{{ $mascota->id }}" {{ old('mascota_id') == $mascota->id ? 'selected' : '' }}>
                                    {{ $mascota->nombre }} - {{ $mascota->especie }} - Dueño: {{ $mascota->propietario }}
                                </option>
                                @endforeach
                            </select>
                            @error('mascota_id')
    ...
    <div id="modal-tipo" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-2xl p-8 max-w-xl w-full mx-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <button type="button"
                    onclick="seleccionarTipo('mascota-normal')"
                ...
                <button type="button"
                    onclick="seleccionarTipo('mascota-liquida')"
