...
<head>
    ...
    <title>Reporte de Biopsias - Mascotas</title>
    <script>
...
<body>
    ...
    <div class="header">
        ...
        <p>Reporte de Biopsias - Mascotas</p>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <small>{{ $biopsia->mascota->especie }} - {{ $biopsia->mascota->raza }}</small>
                </td>
                <td>{{ $biopsia->mascota->propietario }}</td>
                <td>
            ...
            <tr>
                <td colspan="7" class="no-data">
                    No se encontraron biopsias de mascotas con los filtros aplicados
                </td>
            </tr>
            @endforelse
        </tbody>
