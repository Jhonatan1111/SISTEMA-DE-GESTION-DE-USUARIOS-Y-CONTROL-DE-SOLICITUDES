        ...
        <div class="flex-1 min-w-[230px]">
            <div class="relative">
                <input type="text" 
                    ...
                    placeholder="Buscar por mascota, propietario, doctor o diagnóstico..."
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <form action="{{ route('biopsias.mascotas.toggle-estado', $biopsia->nbiopsia) }}" method="POST" class="inline">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                            class="font-semibold transition-colors {{ $biopsia->estado ? 'text-yellow-600 hover:text-yellow-800' : 'text-green-600 hover:text-green-800' }}">
